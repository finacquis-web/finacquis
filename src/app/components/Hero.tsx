        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <a
              ...
              className="px-10 py-4 bg-[#E8B53C] text-[#0C1D35] text-[13px] tracking-widest hover:bg-[#D4A030] transition-all duration-200 text-center"
              style={{
                fontFamily: "Inter, sans-serif",
                fontWeight: 600,
              }}
            ...
            <a
              ...
              className="px-10 py-4 border border-[#0C1D35]/25 text-[#0C1D35] text-[13px] tracking-widest hover:border-[#0C1D35]/50 transition-all duration-200 text-center"
              style={{
                fontFamily: "Inter, sans-serif",
              }}
            >
